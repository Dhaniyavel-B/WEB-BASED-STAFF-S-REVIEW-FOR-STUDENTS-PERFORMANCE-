    ...
    <div class="d-flex" id="wrapper">
        ...
        <div  id="sidebar-wrapper" style="background-color:#A0A0A0;border-top-left-radius:10px;border-bottom-left-radius:10px">
            ...
            <div class="list-group list-group-flush my-3" >
                ...
                <asp:LinkButton ID="LinkButton3" runat="server"  class="list-group-item list-group-item-action bg-transparent second-text fw-bold" style="color:#8b008b;font-family:sans-serif">Add Staffs</asp:LinkButton>
             ...
             <div class="container" >
                       ...
                       <div class="mb-3 mt-3">
                           ...
                           <asp:TextBox ID="Fullname" type="text" class="form-control w-25" placeholder="Enter FullName" name="Fullname" runat="server" required></asp:TextBox>                         
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Fullname" Display="Dynamic" ErrorMessage="Should Not Contains any Numbers" ForeColor="#CC0000" ValidationExpression="^[a-zA-Z\s]+$" ViewStateMode="Disabled"></asp:RegularExpressionValidator>
