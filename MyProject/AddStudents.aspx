...
#4B2D83;border-top-left-radius:10px;border-bottom-left-radius:10px">
            ...
            <div class="list-group list-group-flush my-3" >
                ...
                <asp:LinkButton ID="LinkButton4" runat="server" class="list-group-item list-group-item-action bg-transparent second-text fw-bold" style="color:white;font-family:sans-serif" >Add Students</asp:LinkButton>
                
                <asp:LinkButton ID="LinkButton3" runat="server" class="list-group-item list-group-item-action bg-transparent second-text fw-bold" style="color:#A0A0A0;font-family:sans-serif" OnClick="LinkButton3_Click">Add Staffs</asp:LinkButton>
